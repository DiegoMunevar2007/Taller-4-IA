...
PICKUP: ActionSchema = ActionSchema(
    ...
    del_list=[("At", "obj", "loc"), ("HandsFree", "r")],
)
...
PUTDOWN: ActionSchema = ActionSchema(
    name="PutDown",
    parameters=["r", "obj", "loc"],
    precond_pos=[("At", "r", "loc"), ("Holding", "r", "obj")],
    precond_neg=[],
    add_list=[("At", "obj", "loc"), ("HandsFree", "r")],
...
SETUP_SUPPLIES: ActionSchema = ActionSchema(
    ...
    add_list=[("SuppliesReady", "loc"), ("HandsFree", "r")],
    del_list=[("Holding", "r", "s")],
)
